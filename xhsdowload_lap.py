...
# CSS Tùy chỉnh: Nút trắng, chữ đỏ, bóng hồng 30% lệch 6px, căn giữa
st.markdown("""
    <style>
    /* Nền trắng sạch sẽ */
    .stApp {
    ...
    /* Thiết kế nút bấm: Thân trắng, chữ đỏ, bóng hồng 30% */
    div.stButton > button {
        ...
        /* Bóng hồng 30% độ trong suốt, lệch xuống 6px và phải 6px */
...
# Tiêu đề khẳng định tác quyền của Nhà văn Lập
...
st.markdown("<p class='centered-text' style='font-size: 1.2em; color: #666 !important;'>Hệ thống lưu trữ tư liệu của <b>Tác giả Lập</b></p>", unsafe_allow_html=True)

# --- HÀM XỬ LÝ KỸ THUẬT ---
def extract_url(text):
    """Tự động lọc link sạch từ nội dung dán vào"""
...
with mid_input:
    raw_input = st.text_area("Dán nội dung bài viết hoặc link vào đây (Hệ thống tự động nhận diện):", 
                            height=100, 
                            placeholder="Anh chỉ cần dán, tôi sẽ làm phần còn lại...")

# Tự động nhận diện link ngay khi dán
...
if not target_link:
    ...
    st.markdown("<div class='status-msg' style='background-color: #fff5f6; color: #ff2442 !important;'>🔴 Đã tìm thấy link! Anh hãy chọn chất lượng để Nhà văn Lập xử lý.</div>", unsafe_allow_html=True)

# 4 Nút chất lượng luôn hiển thị, tập trung ở giữa
st.markdown("<p class='centered-text' style='margin-bottom: 10px;'><b>Chọn chất lượng tải xuống:</b></p>", unsafe_allow_html=True)
